...
public final class Tools {
    ...
    public static <T> String marshalToXml(T obj, QName qName) {
        ...
        try {
            Marshaller marshaller = JAXBContext.newInstance(obj.getClass())
                    .createMarshaller();
            Object element;
            if (qName != null) {
                element = new JAXBElement<T>(qName,
                        (Class<T>) obj.getClass(), obj);
            } else {
                qName = new QName(obj.getClass().getPackage().getName(),
    ...
    public static <T> T unmarshalFromXml(String xml, Class<T> targetClass) {
        ...
        //JAXBElement<T> js=(JAXBElement<T>) jaxb2.unmarshal(new StreamSource(new StringReader(xml)));
        Object obj=jaxb2.unmarshal(new StreamSource(new StringReader(xml)));
        JAXBElement<T> js=(JAXBElement<T>) obj;
        if (js!=null)
        	return js.getValue();
    ...
    public static DateTime toUTC(DateTime localDateTime) {
        ...
        long utcTime = dateTimeZone.convertLocalToUTC(
                localDateTime.getMillis(), false);
    ...
    public static DateTime fromUTC(DateTime utcTime) {
        ...
        long localTime = dateTimeZone
                .convertUTCToLocal(utcTime.getMillis());
